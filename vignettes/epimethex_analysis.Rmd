...
6. indicates whether the methylation data considered are 
    linear(TRUE) or logarithmic(FALSE)
7. indicates whether the genes data considered are 
    linear(TRUE) or logarithmic(FALSE)

#Final Result

the analysis will produce csv files
