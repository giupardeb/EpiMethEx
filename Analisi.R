...
GPL2<-data.frame(V1 = rep(dfGpl$V1, sapply(s, length)), V22 = unlist(s))
...
righeCheTiServono1<-Filter(function(x) !(all(x=="")), righeCheTiServono1)
...
remove(k, j,dfGpl,GPL2,GPL3,GPL4,A,DFtmp)
save.image(file = "AnalisiMultigenica27Maggio.Rdata")
